...
<div class="container">
                <div>
                    <h3 style={{color:"#FF0000"}}>OWNER LOGIN</h3>
                </div>
                <div>
                    <form method="POST" class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="email" name="email" placeholder="Enter your email" class="form-control" onChange={this.emailChangeHandler} required></input>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="password" class="control-label col-sm-2">Password:</label>
                            <div class="col-sm-3">
                                <input type="password" name="password" placeholder="Enter your password" class="form-control" onChange={this.passwordChangeHandler} pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters." required></input>
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div>
                    <Link to="/owner/signup">New to GrubHub? Create Account</Link>
                </div>
            </div>
            </div>
